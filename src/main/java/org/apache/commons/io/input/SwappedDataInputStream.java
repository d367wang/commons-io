    ...
    implements DataInput
{
    ...
    public byte readByte()
        throws IOException, EOFException
    {
        return SignednessConvert.unsignedToSignedByte((byte)in.read());
    }
    ...
    public char readChar()
        throws IOException, EOFException
    {
        return SignednessConvert.signedShortToChar(readShort());
    }
     ...
     */
    @Override
    public @IntRange(from=0, to=255) int readUnsignedByte()
        throws IOException, EOFException
    {
        return in.read();
    }
